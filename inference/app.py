...
if ENABLE_GRADIO:
    demo = gr.Interface(
        ...
        description=(
            ...
            "and Bland-Altman analysis. Saved Kaggle notebook version 18 output for the current "
            "conjunctiva-only run reported 5-fold CV MAE 1.835 +/- 0.096 g/dL, RMSE 2.354 +/- 0.104 g/dL, "
            "AUC 0.660 +/- 0.031, F1 0.353 +/- 0.015, and a final-run best validation MAE of 1.568 g/dL "
            "with peak validation AUC 0.833. **Research tool only -- not a medical device.**\n\n"
